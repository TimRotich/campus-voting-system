index<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="../Science/admin/home.php"><span class="glyphicon glyphicon-lock"></span> <span>Admin Science</span></a></li>
      <li class=""><a href="../Education/admin/home.php"><span class="glyphicon glyphicon-lock"></span> <span>Admin Education</span></a></li>
      <li class=""><a href="../Business/admin/home.php"><span class="glyphicon glyphicon-lock"></span> <span>Admin Business</span></a></li>
      <li class=""><a href="../Agriculture/admin/home.php"><span class="glyphicon glyphicon-lock"></span> <span>Admin Agric & Biotech</span></a></li>
